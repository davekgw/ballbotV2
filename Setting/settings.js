...
export default {
	...
	developer: JSON.parse(fs.readFileSync('./Setting/owner.json')) || ['6285728625940', '6285381039923'], //Nomor owner
	moderator: JSON.parse(fs.readFileSync('./Setting/mod.json')) || [], //Nomor mod [kalo ada]
	prems: JSON.parse(fs.readFileSync('./Setting/prems.json')) || ['6285728625940', '6285381039923'],
